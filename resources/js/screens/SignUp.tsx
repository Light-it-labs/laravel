...
export const SignUp = () => {
    return(
        <div className="flex flex-col text-sm">
            <div className="h-96 w-full bg-cover bg-center bg-no-repeat bg-[url('/images/logo.jpg')]"
                style={{
            ...
            <div>
                <div className="flex flex-col gap-10 p-16">
                    ...
                    <Input info="Mail" type="text"> <MailIcon /> </Input>
                    <Input info="Username" type="text"><UserIcon /></Input>
                    <Input info="Password" type="password"><PadlockIcon /></Input>
                    <Input info="Confirm password" type="password"><PadlockIcon /></Input>
